    ...
    <div className="px-40 py-10 min-h-screen">
      ...
      <div className="mt-8">
        <div className="w-full">
          <div className="flex gap-5 justify-between border border-gray-100 shadow-md rounded-sm px-10 py-5 mb-4">
            <p className="min-w-48 w-56 mr-8 text-lg font-semibold">Product</p>
      ...
      <div className="flex justify-between mt-8">
        <ButtonTemplate
          ...
          btnTextColor="text-gray-800 font-bold"
        />
        <ButtonTemplate
      ...
      <div className="flex justify-between items-start mt-8">
        <div className="flex justify-start items-center gap-4">
          ...
          />
          <button className="bg-secondary px-10 py-2 rounded font-semibold text-white shadow-sm">
            Apply Coupon
          </button>
        </div>
        <div className="border-2 border-gray-700 px-4 py-5 rounded w-1/3">
          ...
          <span className="flex items-center justify-center mt-6">
            <button onClick={() => navigate("checkout")} className="bg-secondary px-10 py-2 rounded font-semibold text-white shadow-sm">
              Process to checkout
            </button>
          </span>
        </div>
